...
log.info("Comprimento de passo: {}".format(comprimento_passo))
print("Média do comprimento de passos: %5.3f" % statistics.mean(comprimento_passo_vetor))
print("Desvio padrão das medições do comprimento de passos: %5.3f" % statistics.pstdev(comprimento_passo_vetor))
