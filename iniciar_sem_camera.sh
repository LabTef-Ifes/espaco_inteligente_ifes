...
sh sh_files/is-rabbitmq.sh
sleep 1

sh sh_files/is-zipkin.sh
sleep 1

sh sh_files/is-mjpeg.sh
sleep 1

sh sh_files/is-frame-transformation.sh
sleep 1

sh sh_files/is-skeletons-grouper.sh
sleep 1

sh sh_files/is-skeletons-detector.sh
